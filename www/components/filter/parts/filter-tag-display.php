	...
	<div class="form-group form-group-md">
		...
		<div class='col-md-11' id='tags'>
			...
			<div class='btn-group' role='group'>
				<button type='button' class='btn btn-warning btn-sm tag-filter <?php echo (strstr($_SESSION['tags'], 'Bureau') ? "active" : "");?>' data-filter='Bureau' >Bureau</button>
			...
			<div class='btn-group' role='group'>
				...
				<button type='button' class='btn btn-success btn-sm tag-filter <?php echo (strstr($_SESSION['tags'], 'Formation') ? "active" : "");?>' data-filter='Formation' >Form.</button>
				...
				<button type='button' class='btn btn-success btn-sm tag-filter <?php echo (strstr($_SESSION['tags'], 'Acso') ? "active" : "");?>' data-filter='Acso' >Acso</button>
			</div>
			<div class='btn-group' role='group'>
				<button type='button' class='btn btn-danger btn-sm tag-filter <?php echo (strstr($_SESSION['tags'], 'Pôle') ? "active" : "");?>' data-filter='Pôle' >Pôles</button>
