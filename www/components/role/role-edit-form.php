<form class="form-horizontal" id="auto-validation-form" action='' role="form" method='post' accept-charset='utf-8'>
  ...
  <div class="form-group form-group-sm required has-feedback <?php echo $feedback[0];?>">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="role_title" name="role_title" aria-describedby="role-title-error" placeholder="CO Asnières" minlength='3' maxlength='120' required='true' value="<?php echo htmlentities($role_title);?>" >
  ...
  <div class="form-group form-group-sm required has-feedback <?php echo $feedback[0];?>">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="role_description" name="role_description" aria-describedby="role-description-error" placeholder="Coordinateur des Opérations d'Asnières" minlength='3' maxlength='120' required='true' value="<?php echo htmlentities($role_description);?>" />
      <span class="form-control-feedback glyphicon <?php echo $feedback[1];?>" aria-hidden="true"></span>
