<form class="form-horizontal" id="auto-validation-form" action='' role="form" method='post' accept-charset='utf-8'>
  ...
  <div class="form-group form-group-sm has-feedback <?php echo $feedback[0];?>">
    ...
    <div class="col-sm-8">
      <input type="tel" class="form-control" id="role_phone" name="role_phone" aria-describedby="role-phone-error" placeholder="Télephone de fonction" minlength='10' maxlength='10' digits='true' value="<?php echo $role_phone;?>" data-minlength="10" >
      <span class="form-control-feedback glyphicon <?php echo $feedback[1];?>" aria-hidden="true"></span>
  ...
  <div class="form-group form-group-sm has-feedback <?php echo $feedback[0];?>">
    ...
    <div class="col-sm-8">
      <input type="email" class="form-control" id="role_email" name="role_email" aria-describedby="role-email-error" placeholder="E-mail de fonction" minlength='4' email='true' value="<?php echo $role_email;?>" data-minlength="10" />
      <span class="form-control-feedback glyphicon <?php echo $feedback[1];?>" aria-hidden="true"></span>
  ...
  <div class="form-group form-group-sm has-feedback <?php echo $feedback[0];?>">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="role_callsign" name="role_callsign" aria-describedby="role-callsign-error" placeholder="OPE 92 Alpha" minlength='3' maxlength='120' value="<?php echo $role_callsign;?>" />
      <span class="form-control-feedback glyphicon <?php echo $feedback[1];?>" aria-hidden="true"></span>
  ...
  <div class="form-group form-group-sm has-feedback <?php echo $feedback[0];?>">
    ...
    <div class="col-sm-8">
      <input type="number" class="form-control" id="role_hierarchy" name="role_hierarchy" aria-describedby="role-hierarchy-error" placeholder="10" minlength='1' maxlength='4' digits='true' value="<?php echo $role_hierarchy;?>"data-minlength="1">
      <span class="form-control-feedback glyphicon <?php echo $feedback[1];?>" aria-hidden="true"></span>
  ...
  <div class="form-group form-group-sm has-feedback <?php echo $feedback[0];?>">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="role_tags" name="role_tags" aria-describedby="role-tags-error" placeholder="Opérationnel|Bureau"  required='false' value="<?php echo $role_tags;?>" >
      <span class="form-control-feedback glyphicon <?php echo $feedback[1];?>" aria-hidden="true"></span>
