<div class="panel panel-primary">
  ...
  <div id='orga-panel-filter' aria-expanded='true' class="panel-body in">
    ...
    <div class="form-group form-group-sm has-feedback <?php echo $feedback[0];?>">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" id="client_represent" name="client_represent" aria-describedby="client-represent-error" placeholder="Représentant" minlength='4' required='true' value="<?php echo htmlentities($client_represent);?>" />
        <span class="form-control-feedback glyphicon <?php echo $feedback[1];?>" aria-hidden="true"></span>
    ...
    <div class="form-group form-group-sm has-feedback <?php echo $feedback[0];?>">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" id="client_title" name="client_title" aria-describedby="client-title-error" placeholder="Qualité" minlength='4' required='true' value="<?php echo htmlentities($client_title);?>" >
        <span class="form-control-feedback glyphicon <?php echo $feedback[1];?>" aria-hidden="true"></span>
