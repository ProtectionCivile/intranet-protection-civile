  ...
  <div id='orga-panel-filter' aria-expanded='true' class="panel-body in">
	    ...
	    <div class="row">
	      ...
	      <div class="col col-sm-3">
	        <p class='bg-info'><?php echo ($client_name) ? $client_name : '&nbsp;';?> </p>
	      </div>
	    </div>
	    ...
	    <div class="row">
	      ...
	      <div class="col col-sm-3">
	        <p class='bg-info' ><?php echo ($client_represent) ? $client_represent : '&nbsp;';?></p>
	      </div>

	      <div class="col col-sm-1 text-right">Qualité</div>
	      <div class="col col-sm-3">
	        <p class='bg-info' ><?php echo ($client_title) ? $client_title : '&nbsp;';?> </p>
	      </div>
	    </div>
	    ...
	    <div class="row">
	      ...
	      <div class="col col-sm-7">
	        <p class='bg-info' ><?php echo ($client_address) ? $client_address : '&nbsp;';?>  </p>
	      </div>
	    </div>
			...
			<div class='row'>
				...
				<div class="col-sm-2">
				  <p class='bg-info' ><?php echo ($client_phone) ? $client_phone : '&nbsp;';?> </p>
				</div>
	      <div class="col col-sm-2 text-right">Fax</div>
	      <div class="col-sm-2">
	        <p class='bg-info'><?php echo ($client_fax) ? $client_fax : '&nbsp;';?></p>
	      </div>
	    </div>
			...
			<div class='row'>
				...
				<div class="col-sm-6">
				   <p class='bg-info'><?php echo ($client_email) ? $client_email : '&nbsp;';?></p>
				</div>
	    </div>
