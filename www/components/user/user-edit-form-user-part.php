...
<div class="form-group form-group-sm has-feedback <?php echo $feedback[0];?>">
  ...
  <div class="col-sm-8">
    <input type="text" class="form-control" id="user_lastName" name="user_lastName" aria-describedby="user-lastName-error" placeholder="ex: Dupond" minlength='3' required='true' value="<?php echo $user_lastName;?>" />
...
<div class="form-group form-group-sm has-feedback <?php echo $feedback[0];?>">
  ...
  <div class="col-sm-8">
    <input type="text" class="form-control" id="user_firstName" name="user_firstName" aria-describedby="user-firstName-error" placeholder="ex: Jean" minlength='3' required='true' value="<?php echo $user_firstName;?>" />
    <span class="form-control-feedback glyphicon <?php echo $feedback[1];?>" aria-hidden="true"></span>
...
<div class="form-group form-group-sm has-feedback <?php echo $feedback[0];?>">
  ...
  <div class="col-sm-8">
    <input type="text" class="form-control" id="user_login" name="user_login" aria-describedby="user-login-error" placeholder="ex: 49594" minlength='4' maxlength='8' required='true' digits='true' value="<?php echo $user_login;?>" />
    <span class="form-control-feedback glyphicon <?php echo $feedback[1];?>" aria-hidden="true"></span>
...
<div class="form-group form-group-sm has-feedback <?php echo $feedback[0];?>">
  ...
  <div class="col-sm-8">
    <input type="tel" class="form-control" id="user_phone" name="user_phone" aria-describedby="user-phone-error" placeholder="telephone" minlength='10' maxlength='10' required='true' digits='true' value="<?php echo $user_phone;?>" data-minlength="10" >
    <span class="form-control-feedback glyphicon <?php echo $feedback[1];?>" aria-hidden="true"></span>
...
<div class="form-group form-group-sm has-feedback <?php echo $feedback[0];?>">
  ...
  <div class="col-sm-8">
    <input type="email" class="form-control" id="user_email" name="user_email" aria-describedby="user-email-error" placeholder="E-mail" minlength='4' email='true' value="<?php echo $user_email;?>" data-minlength="10" />
    <span class="form-control-feedback glyphicon <?php echo $feedback[1];?>" aria-hidden="true"></span>
