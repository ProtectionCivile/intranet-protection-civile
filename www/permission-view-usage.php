		...
		<div class="panel panel-info">
			...
			<div class="panel-body">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<?php 
							$query = "SELECT R.ID, R.Title FROM $tablename_rolepermissions AS RP INNER JOIN rbac_roles AS R ON RP.RoleId=R.ID WHERE RP.PermissionId='$permissionID' ORDER BY R.Title" or die("Erreur lors de la consultation" . mysqli_error($link)); 
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<?php 
							$query = "SELECT U.ID, U.last_name, U.first_name FROM $tablename_rolepermissions AS RP INNER JOIN users AS U ON RP.RoleId=R.ID WHERE RP.PermissionId='$permissionID' ORDER BY U.nom" or die("Erreur lors de la consultation" . mysqli_error($link)); 
