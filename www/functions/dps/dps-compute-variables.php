<?php
	...
	else { $client_name = (isset($dps) && isset($dps['client_name'])) ? $dps['client_name'] : ''; }
	...
	else { $client_represent = (isset($dps) && isset($dps['client_represent'])) ? $dps['client_represent'] : ''; }
	...
	else { $client_title = (isset($dps) && isset($dps['client_title'])) ? $dps['client_title'] : ''; }
	...
	else { $client_address = (isset($dps) && isset($dps['client_address'])) ? $dps['client_address'] : ''; }
	...
	else { $client_phone = (isset($dps) && isset($dps['client_phone'])) ? $dps['client_phone'] : ''; }
	...
	else { $client_fax = (isset($dps) && isset($dps['client_fax'])) ? $dps['client_fax'] : ''; }
	...
	else { $client_email = (isset($dps) && isset($dps['client_email'])) ? $dps['client_email'] : ''; }
	...
	else { $event_name = (isset($dps) && isset($dps['event_name'])) ? $dps['event_name'] : ''; }
	...
	else { $event_description = (isset($dps) && isset($dps['event_description'])) ? $dps['event_description'] : ''; }
	...
	else { $event_address = (isset($dps) && isset($dps['event_address'])) ? $dps['event_address'] : ''; }
	...
	else { $event_department = (isset($dps) && isset($dps['event_department'])) ? $dps['event_department'] : ''; }
	...
	else { $event_begin_date = formatDateUsToFr((isset($dps) && isset($dps['event_begin_date'])) ? $dps['event_begin_date'] : ''); }
	...
	else { $event_begin_time = (isset($dps) && isset($dps['event_begin_time'])) ? $dps['event_begin_time'] : ''; }
	...
	else { $event_end_date = formatDateUsToFr((isset($dps) && isset($dps['event_end_date'])) ? $dps['event_end_date'] : ''); }
	...
	else { $event_end_time = (isset($dps) && isset($dps['event_end_time'])) ? $dps['event_end_time'] : ''; }
	...
	else { $event_pref_secu = (isset($dps) && isset($dps['event_pref_secu'])) ? $dps['event_pref_secu'] : ''; }
	...
	else { $ris_p1_public = (isset($dps) && isset($dps['ris_p1_public'])) ? $dps['ris_p1_public'] : ''; }
	...
	else { $ris_comment = (isset($dps) && isset($dps['ris_comment'])) ? $dps['ris_comment'] : ''; }
	...
	else { $dps_begin_date = formatDateUsToFr((isset($dps) && isset($dps['dps_begin_date'])) ? $dps['dps_begin_date'] : ''); }
	...
	else { $dps_begin_time = (isset($dps) && isset($dps['dps_begin_time'])) ? $dps['dps_begin_time'] : ''; }
	...
	else { $dps_end_date = formatDateUsToFr((isset($dps) && isset($dps['dps_end_date'])) ? $dps['dps_end_date'] : ''); }
	...
	else { $dps_end_time = (isset($dps) && isset($dps['dps_end_time'])) ? $dps['dps_end_time'] : ''; }
	...
	else { $dps_nb_ce = (isset($dps) && isset($dps['dps_nb_ce'])) ? $dps['dps_nb_ce'] : ''; }
	...
	else { $dps_nb_pse2 = (isset($dps) && isset($dps['dps_nb_pse2'])) ? $dps['dps_nb_pse2'] : ''; }
	...
	else { $dps_nb_pse1 = (isset($dps) && isset($dps['dps_nb_pse1'])) ? $dps['dps_nb_pse1'] : ''; }
	...
	else { $dps_nb_psc1 = (isset($dps) && isset($dps['dps_nb_psc1'])) ? $dps['dps_nb_psc1'] : ''; }
	...
	else { $dps_nb_vpsp_transp = (isset($dps) && isset($dps['dps_nb_vpsp_transp'])) ? $dps['dps_nb_vpsp_transp'] : ''; }
	...
	else { $dps_nb_vpsp_soin = (isset($dps) && isset($dps['dps_nb_vpsp_soin'])) ? $dps['dps_nb_vpsp_soin'] : ''; }
	...
	else { $dps_nb_vtu = (isset($dps) && isset($dps['dps_nb_vtu'])) ? $dps['dps_nb_vtu'] : ''; }
	...
	else { $dps_nb_tente = (isset($dps) && isset($dps['dps_nb_tente'])) ? $dps['dps_nb_tente'] : ''; }
	...
	else { $dps_nb_med_asso = (isset($dps) && isset($dps['dps_nb_med_asso'])) ? $dps['dps_nb_med_asso'] : ''; }
	...
	else { $dps_nb_inf_asso = (isset($dps) && isset($dps['dps_nb_inf_asso'])) ? $dps['dps_nb_inf_asso'] : ''; }
	...
	else { $dps_nb_lot_a = (isset($dps) && isset($dps['dps_nb_lot_a'])) ? $dps['dps_nb_lot_a'] : ''; }
	...
	else { $dps_nb_lot_b = (isset($dps) && isset($dps['dps_nb_lot_b'])) ? $dps['dps_nb_lot_b'] : ''; }
	...
	else { $dps_nb_lot_c = (isset($dps) && isset($dps['dps_nb_lot_c'])) ? $dps['dps_nb_lot_c'] : ''; }
	...
	else { $dps_nb_dae = (isset($dps) && isset($dps['dps_nb_dae'])) ? $dps['dps_nb_dae'] : ''; }
	...
	else { $dps_other_matos_asso = (isset($dps) && isset($dps['dps_other_matos_asso'])) ? $dps['dps_other_matos_asso'] : ''; }
	...
	else { $clientmatos_infirmerie = (isset($dps) && isset($dps['clientmatos_infirmerie'])) ? $dps['clientmatos_infirmerie'] : ''; }
	...
	else { $clientmatos_tente = (isset($dps) && isset($dps['clientmatos_tente'])) ? $dps['clientmatos_tente'] : ''; }
	...
	else { $clientmatos_other = (isset($dps) && isset($dps['clientmatos_other'])) ? $dps['clientmatos_other'] : ''; }
	...
	else { $medicalext_nb_med = (isset($dps) && isset($dps['medicalext_nb_med'])) ? $dps['medicalext_nb_med'] : ''; }
	...
	else { $medicalext_med_company = (isset($dps) && isset($dps['medicalext_med_company'])) ? $dps['medicalext_med_company'] : ''; }
	...
	else { $medicalext_nb_inf = (isset($dps) && isset($dps['medicalext_nb_inf'])) ? $dps['medicalext_nb_inf'] : ''; }
	...
	else { $dps_justification = (isset($dps) && isset($dps['dps_justification'])) ? $dps['dps_justification'] : ''; }

	if (isset($duplicated_dps_array['status'])) { $status = $duplicated_dps_array['status']; }
	elseif (isset($_POST['status'])) { $status = $_POST['status']; }
	else { $status = (isset($dps) && isset($dps['status'])) ? $dps['status'] : ''; }
	...
	else { $cu_year = (isset($dps) && isset($dps['cu_year'])) ? $dps['cu_year'] : ''; }
