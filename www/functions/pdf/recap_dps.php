...
$pdf->Text(40, 82, utf8_decode("13 Avenue du Chat blanc sur la grande branche en ch�ne clair - 92345 Cormeilles En Parisis Sur Marne de la Seine"));
...
$pdf->Text(14, 103, utf8_decode("Activit� / descriptif :"));
$pdf->Text(14, 106, utf8_decode("Lieux pr�cis :"));
$pdf->SetTextColor(210,120,20);
$pdf->Text(40, 100, utf8_decode("Combats Kata et karat� : championnats d�partementaux 2015"));
$pdf->Text(40, 103, utf8_decode("Sport / Karat�"));
$pdf->Text(40, 106, utf8_decode("13 Avenue du Chat blanc sur la grande branche en ch�ne clair - 92345 Cormeilles En Parisis Sur Marne de la Seine"));
$pdf->Text(14, 109, utf8_decode("La manifestation se d�roule le 04-10-2015 de 08H00 � 19H00"));
$pdf->Text(14, 112, utf8_decode("Aucun dossier n'a �t� d�pos� en pr�fecture."));

//RIS
$pdf->SetTextColor(0,64,128);
$pdf->SetFont('Poppins-Semibold','',8);
$pdf->SetXY(12,116);
$pdf->Cell(50,5,utf8_decode("Grille d'�valuation des risques"),1,0,"","true");
...
$pdf->Text(14, 127, utf8_decode("Activit� du rassemblement :"));
$pdf->Text(14, 130, utf8_decode("Accessibilit� et environnement :"));
$pdf->Text(14, 133, utf8_decode("D�lai d'intervention des secours publics :"));
...
$pdf->Text(75, 127, utf8_decode("Public debout (spectacle avec public dynamique, danse f�ria, spectacle de rue, etc.)"));
$pdf->Text(75, 130, utf8_decode("Espace naturels : surfaces Sup�rieur ou �gal �� 5 ha."));
...
$pdf->SetFont('Arial','',7);
$pdf->SetTextColor(0,0,0);
$pdf->Text(14, 163, utf8_decode("Le Dispositif Pr�visionnel de Secours sera activ� du 04-10-2015 � 07H30 au 05-10-2015 � 18H00."));
$pdf->SetFont('Arial','B',7);
...
$pdf->Text(60, 175, utf8_decode("M�decins :"));
...
$pdf->Text(165, 175, utf8_decode("SMG + groupe + tout �a"));
...
$pdf->Text(60, 184, utf8_decode("M�decins ext. :"));
...
$pdf->Text(60, 190, utf8_decode("Inform�, non pr�sent"));
$pdf->Text(140, 190, utf8_decode("Ni inform�, Ni pr�sent"));
...
$pdf->SetFont('Arial','',7);
$pdf->SetTextColor(0,0,0);
$pdf->Text(12, 247, utf8_decode("Le Directeur Local des Op�rations"));
...
$pdf->Text(120, 247, utf8_decode("Le Directeur D�partemental des Op�rations"));
$pdf->Text(120, 250, utf8_decode("Protection Civile des Hauts-de-Seine"));
$pdf->Text(120, 253, utf8_decode("Par int�rim : Pascal Mallet"));
